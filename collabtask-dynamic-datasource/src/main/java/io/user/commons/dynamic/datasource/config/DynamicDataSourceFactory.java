...
public class DynamicDataSourceFactory {
    ...
    public static DruidDataSource buildDruidDataSource(DataSourceProperties properties) {
        logger.info("Building Druid DataSource with URL: {}, Username: {}", properties.getUrl(), properties.getUsername());
        ...
        try {
            ...
            logger.error("Failed to initialize Druid DataSource with URL: {}", properties.getUrl(), e);
            e.printStackTrace();
        }
